...
(function () {
  ...
  const translations = {
    'zh-TW': {
      ...
      'officialvideos.uploads': '官方上傳影片',
      'officialvideos.shorts':  '官方Shorts',
      'noUploads':      '尚無一般上傳影片',
      'noUploads.year': '{year} 年尚無一般上傳影片',
      'search.ovu':     '搜尋影片標題或日期…',
    ...
    'ja': {
      ...
      'officialvideos.uploads': '公式アップロード動画',
      'officialvideos.shorts':  '公式Shorts',
      'noUploads':      '一般動画がありません',
      'noUploads.year': '{year}年の一般動画がありません',
      'search.ovu':     '動画タイトルや日付で検索…',
